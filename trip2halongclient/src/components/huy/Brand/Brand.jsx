...
const Brand = () => {
  return (
    <div className='flex mt-44 w-full items-center flex-col  h-auto bg-[#F4F5F5] pb-[300px]'>
      ...
      <div className="relative w-full h-64 ">
        ...
        <div className="absolute bottom-[-20%] left-5 bg-white border-2 rounded-lg shadow-md">
          <img className='h-28 w-28 rounded-lg' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVepZ7GyVytAw5_jj6FWNc1WePd4ChkqAG8w&s" alt="Logo"  />
        </div>
      </div>
