...
import fetchData from '../../apis/booking_api';
import StarRating from './StarRating';
import NameWithBreak from './NameWithBreak';
          ...
          >
            ...
            <div className={`${viewMode === 'grid' ? 'p-2' : 'p-3 flex flex-col'}`}>
              ...
              <div className='flex flex-row items-center mt-2 text-yellow-400' style={{ display: 'flex', gap: '1px' }}>
                ...
                <p className='text-gray-500 text-[15px]'>(5000 + reviews)</p>
              </div>

              <p className='text-[16px] mt-4 text-gray-600'>{tte.description}</p>
            </div>
