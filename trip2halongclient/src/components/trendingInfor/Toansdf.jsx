                        ...
                        <div className='flex flex-row w-full h-auto'>
                                ...
                                <div className='flex flex-row w-full h-[40px]'>
                                    <div className="relative inline-block w-[20%] text-left">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center w-full h-full font-medium bg-gray-200 rounded-l focus:outline-none"
                                        >
                                    ...
                                    <input
                                        ...
                                        className="border border-gray-300 px-2 rounded-r w-[80%] h-full font-sans focus:outline-none"
                                    />
                                </div>
                            ...
                            <div className='flex flex-col w-1/2 h-auto ml-2'>
                                ...
                                <input
                                    type="text"
                                    placeholder="Name"
                                    className="border border-gray-300 rounded-md w-full h-[42px] font-sans px-2 focus:outline-none"
                                />
                                <p className='text-[15px] text-black font-medium mt-3'>Email<span className='text-red-600'>*</span></p>
                                <input
                                    type="text"
                                    placeholder="Email"
                                    className="border border-gray-300 rounded-md w-full h-[40px] font-sans px-2 focus:outline-none"
                                />
                            </div>
                        </div>
                    </div>
