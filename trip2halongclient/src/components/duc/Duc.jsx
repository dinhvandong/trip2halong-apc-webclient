...
const Duc = () => {
  ...
  return (
    <div className='bg-slate-100 w-full items-center flex flex-col mt-[50px] h-screen'>
      ...
      <div className='text-center w-[600px] flex mt-5 '>
      Email
      ...
      <div className=' mt-3'>or sign in with

      </div>
      <div className='flex items-center'>
        <button className='h-[50px] w-[50px] mt-3 bg-green-600 flex justify-center items-center'>
