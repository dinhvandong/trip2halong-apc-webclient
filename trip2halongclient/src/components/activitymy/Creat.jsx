...
const Creat = () => {
    return (
        <div className='flex flex-col w-full h-auto p-2 bg-white'>
            ...
            <div className='flex flex-col w-full h-auto bg-[#e1e3e1] border border-gray-300 rounded-md'>
                ...
                <div className='flex flex-col w-full h-auto'>
                    {newAc.map((ite) => (
                        <div key={ite} className='flex flex-row items-center justify-between w-full h-auto p-4 py-2 border border-gray-300'>
