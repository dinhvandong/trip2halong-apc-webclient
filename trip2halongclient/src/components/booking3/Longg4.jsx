...
const Longg4 = () => {
    ...
    return (
        <div className='flex flex-col bg-[#F2F2F2] w-full h-auto px-36 '>
            <h1 className='px-5 py-2 text-3xl font-bold text-[#505556] mt-3'>Guests Reviews</h1>
            ...
            <div className='flex items-center justify-center w-full h-auto mt-3 mb-4 '>
                <button onClick={gotonext} className='bg-[#167DC8] px-20 py-3 rounded-lg  cursor-pointer text-white font-bold'>Proceed Payment</button>
            </div>
        </div>
    )
}
