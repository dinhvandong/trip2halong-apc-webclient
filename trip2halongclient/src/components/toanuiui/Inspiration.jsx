        ...
        <div className='flex flex-col w-[88%] h-full '>
          <div className='w-full h-[30%] flex flex-row items-center'>
            <p className='text-[35px] text-white font-bold leading-none'>
              Inspiration For Your <span className='ml-1 mr-1 text-yellow-400'>Trip to Halong</span>
              <br />
              <span className='text-[13px] text-white font-medium'>It's here: Our ultimate list of places to experience</span>
            </p>
